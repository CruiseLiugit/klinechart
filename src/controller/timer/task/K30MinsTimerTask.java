 ...
 *
 */
public class K30MinsTimerTask extends TimerTask {
	// 生成网络服务对象
			...
			public K30MinsTimerTask(){}
			
			public K30MinsTimerTask(ServletContext context){
			...
			public void run() {
				...
				String url1 = Constants.K30MinsURL + "1";
				String url2 = Constants.K30MinsURL + "2";
				String url3 = Constants.K30MinsURL + "3";
				String url4 = Constants.K30MinsURL + "4";
				...
				try {
					...
					ft.createJsonFile(servletContext,jsonarr, "30minsjson.txt");
